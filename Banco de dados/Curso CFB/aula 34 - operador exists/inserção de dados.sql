...
insert into cliente (i_cliente_cliente,s_nomecliente_cliente,s_cpf_cliente,i_tipocliente_cliente) values ((select max(c.i_cliente_cliente) from cliente as c) + 1,'Torisvaldo','15935723698',1);
insert into cliente (i_cliente_cliente,s_nomecliente_cliente,s_cpf_cliente,i_tipocliente_cliente) values ((select max(c.i_cliente_cliente) from cliente as c) + 1,'Romerland','15463723698',1);
insert into cliente (i_cliente_cliente,s_nomecliente_cliente,s_cpf_cliente,i_tipocliente_cliente) values ((select max(c.i_cliente_cliente) from cliente as c) + 1,'Camistel','15935724239',1);
insert into cliente (i_cliente_cliente,s_nomecliente_cliente,s_cpf_cliente,i_tipocliente_cliente) values ((select max(c.i_cliente_cliente) from cliente as c) + 1,'Lourivaldo','15935742136',1);
