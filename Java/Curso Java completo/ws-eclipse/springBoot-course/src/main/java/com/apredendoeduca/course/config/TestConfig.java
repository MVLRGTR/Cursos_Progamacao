package com.apredendoeduca.course.config;
...
import com.apredendoeduca.course.repositories.OrderItemRepository;
...
@Configuration
@Profile("test")
public class TestConfig implements CommandLineRunner{ //o comandlinerun serve para aplicar um código quando a aplicação é iniciada
