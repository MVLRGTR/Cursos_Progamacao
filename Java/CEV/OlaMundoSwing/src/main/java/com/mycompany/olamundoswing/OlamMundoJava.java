 ...
 */
public class OlamMundoJava extends javax.swing.JFrame {

    /**
     * Creates new form OlamMundoJava
     */
    public OlamMundoJava() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnClick.setForeground(new java.awt.Color(204, 255, 51));
    ...
    public void btnClickMouseClicked(java.awt.event.ActionEvent evt){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OlamMundoJava.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OlamMundoJava().setVisible(true);
            }
        });
    }
