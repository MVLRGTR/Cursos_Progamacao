 ...
 */
package com.mycompany.tiposprimitivosexe1;

/**
 *
 * @author Marcos Ribeiro
 */
public class TelaPrimitivos extends javax.swing.JFrame {

    /**
     * Creates new form TelaPrimitivos
     */
    public TelaPrimitivos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPrimitivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPrimitivos().setVisible(true);
            }
        });
    }
