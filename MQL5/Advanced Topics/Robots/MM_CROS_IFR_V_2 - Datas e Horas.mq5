...
input string inicio_op                     = "10:00";       // Horário para iniciar operações
input string fim_op                        = "17:30";       // Horário para finalizar operações
    ...
    if(temosNovaVela && horaPodeOperar(inicio_op,fim_op) )
      {
       ...
       // Condição de Compra:
       if(Comprar && PositionSelect(_Symbol)==false && saberDiaDaSemana(TimeCurrent()) != 4  )
         {
