...
void CompraAMercado()
   {
      ...
      Print("::: NormalizeDouble(tick.ask - SL*_Point,_Digits) = ", NormalizeDouble(tick.ask - SL,_Digits));
      
      trade.Buy(num_lots,_Symbol,NormalizeDouble(tick.ask,_Digits),NormalizeDouble(tick.ask - SL,_Digits),
                NormalizeDouble(tick.ask + TK,_Digits));
...
void VendaAMercado()
   {
      ...
      Print("::: NormalizeDouble(tick.bid + SL*_Point,_Digits) = ", NormalizeDouble(tick.bid + SL,_Digits));
      
      
      trade.Sell(num_lots,_Symbol,NormalizeDouble(tick.bid,_Digits),NormalizeDouble(tick.bid + SL,_Digits),
                  NormalizeDouble(tick.bid - TK,_Digits));
