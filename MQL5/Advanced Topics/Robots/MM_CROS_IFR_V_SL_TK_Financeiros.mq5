...
input double fim_SL                        = 200;           // Stop Loss financeiro   
input double fim_TK                        = 250;           // Take profit financeiro
      ...
      if(PositionSelect(_Symbol))
        {
          ...
          if(lucro <= -fim_SL)
            {
               FecharPosicao();
               Print(":: Limite de perdas atingido -> R$ ", fim_SL);
            }
          
          if(lucro >= fim_TK)
            {
               FecharPosicao();
               Print(":: Limite de ganho atingido -> R$ ", fim_TK);
            }
